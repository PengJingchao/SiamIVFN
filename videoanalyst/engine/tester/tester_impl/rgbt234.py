...
from siamfcpp.evaluation.got_benchmark.experiments import ExperimentRGBT

from ..tester_base import TRACK_TESTERS, TesterBase
from .utils.got_benchmark_helper import PipelineTracker, PipelineTrackerRgbtFusion


@TRACK_TESTERS.register
class RGBT234Tester(TesterBase):
    r"""RGBT234 tester
    ...
    extra_hyper_params = dict(
        device_num=1,
        data_root="datasets/RGBT234",
        subsets=[""],
    )


    def __init__(self, *args, **kwargs):
        super(RGBT234Tester, self).__init__(*args, **kwargs)
    ...
    def test(self, ):
        ...
        for subset in self._hyper_params["subsets"]:
            ...
            experiment = ExperimentRGBT(root_dir,
            ...
            if nr_devs == 1:
                ...
                pipeline_tracker = PipelineTrackerRgbtFusion(tracker_name, self._pipeline)
    ...
    def worker(self, dev_id, dev, subset, slicing_quantile):
        ...
        pipeline_tracker = PipelineTrackerRgbtFusion(tracker_name, pipeline)
...
RGBT234Tester.default_hyper_params = copy.deepcopy(RGBT234Tester.default_hyper_params)
RGBT234Tester.default_hyper_params.update(RGBT234Tester.extra_hyper_params)
