...
class GTOTTester(TesterBase):
    ...
    extra_hyper_params = dict(
        device_num=1,
        data_root="datasets/GTOT",
        subsets=[""],
    )


    def __init__(self, *args, **kwargs):
        super(GTOTTester, self).__init__(*args, **kwargs)
...
GTOTTester.default_hyper_params = copy.deepcopy(GTOTTester.default_hyper_params)
GTOTTester.default_hyper_params.update(GTOTTester.extra_hyper_params)
